...
A top speed of 71 km/h was measured. Without the involuntary abort, an estimated 80 km/h would have been reached. It was clearly shown that the target mark of 100 km/h is realistic and feasible on a correspondingly large and clean asphalt surface.

## Error pattern and problems encountered
* **Collision:** During the speedrun, a driving error or loss of control occurred, during which the vehicle crashed into the driver's foot. 
* **Driving behavior:** The front end still feels a bit spongy and does not yet offer optimal directional stability at these high speeds.
